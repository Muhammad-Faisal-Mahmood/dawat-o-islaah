  ...
  return (
    <div className="max-w-md bg-white shadow-md rounded-lg overflow-hidden">
      ...
      <div className="relative  ">
        <img
          src="https://images.squarespace-cdn.com/content/v1/5d016c1ba9f2e7000120c08c/1560579210527-7LDCZH62S91OLOJIKAE9/AdobeStock_87517185.jpeg" // Replace with your image URL
          alt="Post Thumbnail"
      ...
      <div className="p-4">
        ...
        <div className="flex items-center text-gray-600 text-sm mb-3">
          ...
          <span className="mr-4">Islaah, Islamic, Islamic Posts</span>
